...
void ClassInfo::read_names_file_et2( const char *filename )
{
    // TODO: ClassInfo::set_main_flag();
    ClassInfo::read_names_file_no_mainfunc_et2( filename );
}

// -- Read in the names file with main
void ClassInfo::read_names_file_no_mainfunc_et2( const char *filename )
{
    ClassInfo::unset_main_flag();
    string main_class("--NOMAIN--");
    ClassInfo::impl_read_names_file_et1( filename,
...
// -- Read in the names file
void ClassInfo::__read_names_file_et2( const char *filename,
                                       string main_class,
                                       string main_function )
{
    FILE* f = fopen(filename, "r");
